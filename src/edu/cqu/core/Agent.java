...
public abstract class Agent extends Process{
    ...
    protected Map<Integer,int[][]> constraintCosts;  //约束矩阵 Integer表示本智能体与其他关联体的id号  int[][]表示本智能体与其他关联体的取值
    protected Map<Integer,int[]> neighbourDomains;  //邻居值域
    private Map<Integer,Integer> localView;
    protected int valueIndex;  //目前取值
    ...
    protected int updateLocalView(int neighbourId,int valueIndex){      //更新当前邻居取值
