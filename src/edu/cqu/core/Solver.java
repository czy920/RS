...
public class Solver {
    ...
    public void multiBatchSolve(String agentDescriptorPath,String agentType,String problemDir,int validateTime,FinishedListener listener,ProgressChangedListener progressChangedListener){
        ...
        public void run() {
            while (true){
                synchronized (isSolving){
                    ...
                    System.out.println(" begin: " + formatter.format(date) + " Solving " +currentProblemIndex + " " + problemPaths[currentProblemIndex]);
