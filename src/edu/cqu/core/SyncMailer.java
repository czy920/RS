...
//            System.out.println("message size : " + resultCycle.getMsgSizeCnt());
//            System.out.println("UB : " + resultCycle.getTotalCost());
//            System.out.println("NCCC: " + resultCycle.getNcccs());
...
//            this.resultCycle.setNcccs(resultCycle.getNcccs());
//            this.resultCycle.setTotalCost(sumCost);
            this.resultCycle.setNcccs(ncccs);//origin
            if (listener != null){
