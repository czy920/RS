...
public abstract class RetentionFrameUB extends DFSSyncAgent {
...
//    protected OptElement[] localC; //我加的
    ...
    public RetentionFrameUB(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
