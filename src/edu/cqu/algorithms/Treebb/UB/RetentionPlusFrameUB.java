package edu.cqu.algorithms.Treebb.UB;
...
public abstract class RetentionPlusFrameUB extends RetentionFrameUB {

    private ArrayList<OptHistory> optHistories;
    private Map<Integer,Integer> proportion;

    public RetentionPlusFrameUB(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
