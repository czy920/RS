package edu.cqu.algorithms.Treebb;
...
public abstract class RetentionFrame extends DFSSyncAgent {
    ...
    public RetentionFrame(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
    ...
    protected boolean optContainsAllInfinity(){
        for (int i = 0; i < domain.length; i++){
            for (int child : children){
