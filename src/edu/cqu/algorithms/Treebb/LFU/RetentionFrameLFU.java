...
public abstract class RetentionFrameLFU extends DFSSyncAgent {
    ...
    public RetentionFrameLFU(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
