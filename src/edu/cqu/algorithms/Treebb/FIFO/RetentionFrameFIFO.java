...
public abstract class RetentionFrameFIFO extends DFSSyncAgent {
    ...
    public RetentionFrameFIFO(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
