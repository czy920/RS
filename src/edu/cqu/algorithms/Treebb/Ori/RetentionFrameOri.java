...
public abstract class RetentionFrameOri extends DFSSyncAgent {
    ...
    public RetentionFrameOri(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
