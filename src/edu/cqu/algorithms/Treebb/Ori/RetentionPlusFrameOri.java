...
public abstract class RetentionPlusFrameOri extends RetentionFrameOri {

    private ArrayList<OptHistory> optHistories;
    private Map<Integer,Integer> proportion;

    public RetentionPlusFrameOri(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
