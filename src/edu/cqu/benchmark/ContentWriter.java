...
import edu.cqu.benchmark.scalefreenetworks.AsymScaleFreeNetworkGenerator;
...
public class ContentWriter {
    ...
    public static final String PROBLEM_ASYMETIRC_SCALE_FREE_NETWORK = "ASYMETIRC_SCALE_FREE_NETWORK";
    ...
    public void generate() throws Exception{
        ...
        for (int i = 0; i < nbInstance; i++){
            ...
            else if (problemType.equals(PROBLEM_ASYMETIRC_SCALE_FREE_NETWORK)) {
                graph = new AsymScaleFreeNetworkGenerator("instance" + i,nbAgent,domainSize,minCost,maxCost,(Integer)extraParameter.get("m1"),(Integer)extraParameter.get("m2"));
            }
...
//                para.put("mintt",1);
                ...
                //+String.valueOf(agentNum);//+"/" +
                String path = "problem//DCOP//" + String.valueOf(i);
//                String path = "rebte//" + String.valueOf(28);
...
//        String problemType = PROBLEM_RANDOM_DCOP;
//        //+String.valueOf(agentNum);//+"/" +
//        String path = "problem/dcop/kingnoatTest" + String.valueOf(agentNum);
//        generateProblems(problemType, para, agentNum, domainsize, path);
    ...
    private static void generateProblems(String problemType, Map<String, Object> para, int agentNum, int domainsize, String path) throws Exception {
        ...
        ContentWriter writer = new ContentWriter(50,path,agentNum,domainsize,1,100,problemType,para);
        writer.generate();
    }
